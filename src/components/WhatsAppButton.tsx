...
export function WhatsAppButton() {
  return (
    ...
    >
      <span className="absolute -inset-2 rounded-full bg-[#25D366]/40 blur-md animate-pulse" />
      <span className="relative inline-flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-elevate ring-4 ring-white">
